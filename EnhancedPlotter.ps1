#DEVELOPER TODO: 
#Add checks for sufficient free space on destination drive for all plots requested, warn if not
#Support multiple plot destination drives
#Add throughput calculator (use -passthru parameter to get process handle and follow)
